...
?>
	...
	<a class="btn btn-primary" href="pesan.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-back" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2z"/>
	...
	$data = mysqli_query($koneksi,"select * from pesan where nama_barang='$nama_barang'");
	while($d = mysqli_fetch_array($data)){
		?>
		<form method="post" action="updatepesan.php">
			<table>
				<tr>			
					<td>Nama_Barang</td>
					<td>
